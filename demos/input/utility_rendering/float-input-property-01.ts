...
document.getElementById('clearenable').addEventListener("click", () => {
    ...
    Input.setEnabled(false, element4);
    ...
    Input.setEnabled(false, element9);
    Input.setEnabled(false, element20);
